...
var TestingTemplateSchema = new Schema({
...
var CorrosionResistanceTestTemplateSchema = new Schema({
  materialAndCondition: {
    type: String,
    "default": undefined
  },
...
var ControlOfElectroplatingAndChemicalProcessTemplateSchema = new Schema({
  sheetNumber: {
    type: String,
    "default": undefined
  },
...
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('id').get(function () {
  return this._id.toHexString();
});
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('createdAtMs').get(function () {
  var _this$createdAt4;
  return (_this$createdAt4 = this.createdAt) === null || _this$createdAt4 === void 0 ? void 0 : _this$createdAt4.getTime();
});
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('updatedAtMs').get(function () {
  var _this$updatedAt4;
  return (_this$updatedAt4 = this.updatedAt) === null || _this$updatedAt4 === void 0 ? void 0 : _this$updatedAt4.getTime();
});
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('operatorSignedDateMs').get(function () {
...
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('inspectorSignedDateMs').get(function () {
...
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('laboratoriumPersonnelSignedDateMs').get(function () {
...
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('beforeSaltSprayTestingLaboratoriumPersonnelSignedDateMs').get(function () {
...
ControlOfElectroplatingAndChemicalProcessTemplateSchema.virtual('afterSaltSprayTestingLaboratoriumPersonnelSignedDateMs').get(function () {
